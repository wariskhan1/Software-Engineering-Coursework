...
CREATE VIEW descending_countries AS
SELECT Name, Population
FROM country
ORDER BY Population DESC;

CREATE VIEW Asia_descending_countries AS
SELECT Name, Population
FROM country
WHERE Continent = "Asia"
ORDER BY Population DESC;

CREATE VIEW Europe_descending_countries AS
SELECT Name, Population
FROM country
WHERE Continent = "Europe"
ORDER BY Population DESC;

CREATE VIEW NorthAmerica_descending_countries AS
SELECT Name, Population
FROM country
WHERE Continent = "North America"
ORDER BY Population DESC;

CREATE VIEW Africa_descending_countries AS
SELECT Name, Population
FROM country
WHERE Continent = "Africa"
ORDER BY Population DESC;

CREATE VIEW Oceania_descending_countries AS
SELECT Name, Population
FROM country
WHERE Continent = "Oceania"
ORDER BY Population DESC;

CREATE VIEW Antarctica_descending_countries AS
SELECT Name, Population
FROM country
WHERE Continent = "Antarctica"
ORDER BY Population DESC;

CREATE VIEW SouthAmerica_descending_countries AS
SELECT Name, Population
FROM country
...
CREATE VIEW descending_cities AS
SELECT Name, Population
FROM city
ORDER BY Population DESC;


CREATE VIEW descending_capital_cities AS
...
CREATE VIEW most_popular_languages AS
SELECT Language, Percentage DIV 77530000 AS "% of the world population"
FROM countrylanguage
ORDER BY Percentage DESC;


CREATE VIEW capital_city_report AS
SELECT c.Name, c.Population
FROM city c, country ct
WHERE c.ID = ct.Capital;


CREATE VIEW country_report AS
SELECT Code, Name, Continent, Population, Region, Capital
FROM country;
