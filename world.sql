...
--
-- Host: db
-- Generation Time: Mar 24, 2022 at 01:35 PM
...
--
-- Stand-in structure for view `africa_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `africa_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `antarctica_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `antarctica_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `asia_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `asia_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `capital_city_report`
-- (See below for the actual view)
--
CREATE TABLE `capital_city_report` (
`Name` char(35)
,`Population` int
,`Country` char(52)
);
...
--
-- Stand-in structure for view `city_report`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `continent_population_report`
-- (See below for the actual view)
--
CREATE TABLE `continent_population_report` (
`ContinentName` enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America')
,`ContinentPopulation` decimal(32,0)
,`%_of_PopulationLivingInCities` decimal(39,4)
,`%_of_PopulationNotLivingInCities` decimal(40,4)
);
...
--
-- Stand-in structure for view `country_report`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `descending_capital_cities`
-- (See below for the actual view)
--
CREATE TABLE `descending_capital_cities` (
`Name` char(35)
,`Population` int
);
...
--
-- Stand-in structure for view `descending_cities`
-- (See below for the actual view)
--
CREATE TABLE `descending_cities` (
`Name` char(35)
,`Population` int
);
...
--
-- Stand-in structure for view `descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `europe_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `europe_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `northamerica_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `northamerica_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `oceania_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `oceania_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Stand-in structure for view `southamerica_descending_countries`
-- (See below for the actual view)
--
CREATE TABLE `southamerica_descending_countries` (
`Name` char(52)
,`Population` int
);
...
--
-- Structure for view `africa_descending_countries`
--
DROP TABLE IF EXISTS `africa_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `africa_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'Africa') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `antarctica_descending_countries`
--
DROP TABLE IF EXISTS `antarctica_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `antarctica_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'Antarctica') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `asia_descending_countries`
--
DROP TABLE IF EXISTS `asia_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `asia_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'Asia') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `capital_city_report`
--
DROP TABLE IF EXISTS `capital_city_report`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `capital_city_report`  AS SELECT `c`.`Name` AS `Name`, `c`.`Population` AS `Population`, `ct`.`Name` AS `Country` FROM (`city` `c` join `country` `ct`) WHERE (`c`.`CountryCode` = `ct`.`Code`)  ;

-- --------------------------------------------------------

--
-- Structure for view `city_report`
--
DROP TABLE IF EXISTS `city_report`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `city_report`  AS SELECT `c`.`Name` AS `Name`, `c`.`District` AS `District`, `c`.`Population` AS `Population`, `ct`.`Name` AS `Country` FROM (`city` `c` join `country` `ct`) WHERE (`ct`.`Code` = `c`.`CountryCode`)  ;

-- --------------------------------------------------------

--
-- Structure for view `continent_population_report`
--
DROP TABLE IF EXISTS `continent_population_report`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `continent_population_report`  AS SELECT `ct`.`Continent` AS `ContinentName`, sum(`ct`.`Population`) AS `ContinentPopulation`, ((sum(`c`.`Population`) / sum(`ct`.`Population`)) * 100) AS `%_of_PopulationLivingInCities`, (((sum(`ct`.`Population`) - sum(`c`.`Population`)) / sum(`ct`.`Population`)) * 100) AS `%_of_PopulationNotLivingInCities` FROM (`country` `ct` join `city` `c`) WHERE (`ct`.`Code` = `c`.`CountryCode`) GROUP BY `ct`.`Continent``Continent`  ;

-- --------------------------------------------------------

--
-- Structure for view `country_report`
--
DROP TABLE IF EXISTS `country_report`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `country_report`  AS SELECT `country`.`Code` AS `Code`, `country`.`Name` AS `Name`, `country`.`Continent` AS `Continent`, `country`.`Population` AS `Population`, `country`.`Region` AS `Region`, `country`.`Capital` AS `Capital` FROM `country``country`  ;

-- --------------------------------------------------------

--
-- Structure for view `descending_capital_cities`
--
DROP TABLE IF EXISTS `descending_capital_cities`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `descending_capital_cities`  AS SELECT `c`.`Name` AS `Name`, `c`.`Population` AS `Population` FROM (`city` `c` join `country` `ct`) WHERE (`c`.`ID` = `ct`.`Capital`) ORDER BY `c`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `descending_cities`
--
DROP TABLE IF EXISTS `descending_cities`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `descending_cities`  AS SELECT `city`.`Name` AS `Name`, `city`.`Population` AS `Population` FROM `city` ORDER BY `city`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `descending_countries`
--
DROP TABLE IF EXISTS `descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `europe_descending_countries`
--
DROP TABLE IF EXISTS `europe_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `europe_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'Europe') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `northamerica_descending_countries`
--
DROP TABLE IF EXISTS `northamerica_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `northamerica_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'North America') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `oceania_descending_countries`
--
DROP TABLE IF EXISTS `oceania_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `oceania_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'Oceania') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;

-- --------------------------------------------------------

--
-- Structure for view `southamerica_descending_countries`
--
DROP TABLE IF EXISTS `southamerica_descending_countries`;

CREATE ALGORITHM=UNDEFINED DEFINER=`SE`@`%` SQL SECURITY DEFINER VIEW `southamerica_descending_countries`  AS SELECT `country`.`Name` AS `Name`, `country`.`Population` AS `Population` FROM `country` WHERE (`country`.`Continent` = 'South America') ORDER BY `country`.`Population` AS `DESCdesc` ASC  ;
